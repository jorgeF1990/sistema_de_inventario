...
const views = [
    {
        ...
        sql: `CREATE OR REPLACE VIEW vw_dashboard_resumen AS
            SELECT 
    ...
    },
    {
        ...
        sql: `CREATE OR REPLACE VIEW vw_resumen_productos AS
            SELECT 
    ...
    },
    {
        ...
        sql: `CREATE OR REPLACE VIEW vw_resumen_ventas_diario AS
            SELECT 
    ...
    {
        name: 'vw_stock_alertas',
        sql: `CREATE OR REPLACE VIEW vw_stock_alertas AS
            SELECT 
                id_producto, codigo, nombre, stock_actual, stock_minimo, estado_stock
